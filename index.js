...
app.post('/contact', bparser, (req, res) => {
    ...
    let options = {
        ...
        html: `<p>Name : ${name}</p>
               <p>email : ${email}</p>
               <p>Date : ${new Date().toLocaleString('en-US', { day: 'numeric', month: 'long', weekday: 'long' })}</p>
               <p>Time : ${new Date().toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: true })}</p>
               <p>Message : ${msg}</p>
